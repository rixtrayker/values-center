									...
									<tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												    <a class="dropdown-item" href="{{route('teachers.edit', $record->id)}}"><i class="fa fa-edit"></i> &nbsp; Edit</a></a>
                                                    ...
                                                    <form role="form" action="{{ route('teachers.destroy',$record->id) }}" class="" method="POST">
