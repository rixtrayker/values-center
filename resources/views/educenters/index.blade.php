...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">Centers & Branches</h3>
        </div>
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{ route('educenters.create') }}" class="btn btn-primary font-weight-bolder">
									...
									<tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <form role="form" action="{{ route('educenters.destroy',$record->id) }}" class="" method="POST">
