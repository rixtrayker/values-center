									...
									<tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												    <a class="dropdown-item" href="{{route('students.edit', $record->id)}}"><i class="fa fa-edit"></i> &nbsp; Edit</a></a>
                                                    ...
                                                    <form role="form" action="{{ route('students.destroy',$record->id) }}" class="" method="POST">
