...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">Catchers</h3>
        </div>
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{ route('catchers.create') }}" class="btn btn-primary font-weight-bolder">
						...
						<table id="table_id" class="table table-bordered data_table">
							...
							<tbody>
									...
									<tr>
                                            ...
                                            <td>{{$record->mobile}}</td>
                                            <td>{{$record->byUser->name}}</td>
                                            <td>{{$record->toUser->name}}</td>
                                            <td>{{$record->notes}}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												    <a class="dropdown-item" href="{{route('catchers.edit', $record->id)}}"><i class="fa fa-edit"></i> &nbsp; Edit</a></a>
                                                    ...
                                                    <form role="form" action="{{ route('catchers.destroy',$record->id) }}" class="" method="POST">
