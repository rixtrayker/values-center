...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{ route('vcashes.create') }}" class="btn btn-primary font-weight-bolder">
									...
									<tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												    <a class="dropdown-item" href="{{route('vcashes.edit', $record->id)}}"><i class="fa fa-edit"></i> &nbsp; Edit</a></a>
